...
//            )); ?>
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <? if($organisations->isTranslatable()) : ?>
                    <th>
                        <?= @text('Translations') ?>
                    </th>
                <? endif; ?>
            ...
            <? foreach ($organisations as $organisation) : ?>
                <tr>
                    ...
                    <td>
                        <?= @helper('grid.enable', array('row' => $organisation, 'field' => 'featured')); ?>
                    </td>
                    <? if($organisation->isTranslatable()) : ?>
                        <td>
                            <?= @helper('com://admin/translations.template.helper.language.translations', array(
                                'row' => $organisation->id,
                                'table' => $organisation->getTable()->getName()
                            )); ?>
                        </td>
                    <? endif; ?>
                    <td>
                        <?= $organisation->created_by_name; ?>
                    </td>
                    <td>
                        <?= @helper('date.humanize', array('date' => $organisation->created_on)) ?>
                    </td>
                    <td>
